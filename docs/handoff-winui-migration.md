...
1. Run the generated `release\winui-installer\codex-usage-desktop-setup-0.3.5-x64.exe` interactively with elevation. Do not use silent installer arguments for user acceptance.
